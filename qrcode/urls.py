...
from .views import create_dynamic_form, form_builder, generaterbutton,generate_qrcode

app_name='qrcode'

urlpatterns = [
    # path('',generaterbutton, name='generaterbutton'),
    path('', create_dynamic_form, name='create_dynamic_form'),
    path('form-builder/<int:form_id>/', form_builder, name='form_builder'),
    path('generate-qrcode/<int:form_id>/', generate_qrcode, name='generate_qrcode'),
